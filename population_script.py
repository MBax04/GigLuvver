...
def populate():
    ...
    gig_data = [
        ...
        {'gig_id': '0004', 'name': 'Rock Show', 'date': datetime(2024, 2, 12), 'time': time(hour=21, minute=0),
            'venue': Venue.objects.get(VenueName='Barrowland Ballroom'), 'gig_picture_path': './media/gig_images/will_of_the_people.jpg'},
        {'gig_id': '0005', 'name': 'Eras Tour', 'date': datetime(2024, 8, 28), 'time': time(hour=22, minute=0),
            'venue': Venue.objects.get(VenueName='Hydro'), 'gig_picture_path': './media/gig_images/will_of_the_people.jpg'},
        {'gig_id': '0006', 'name': 'Metallica', 'date': datetime(2024, 4, 11), 'time': time(hour=20, minute=0),
            'venue': Venue.objects.get(VenueName='King Tuts Wah Wah Hut'), 'gig_picture_path': './media/gig_images/will_of_the_people.jpg'},
        {'gig_id': '0007', 'name': 'Iron Maiden', 'date': datetime(2024, 11, 22), 'time': time(hour=19, minute=0),
            'venue': Venue.objects.get(VenueName='QMU'), 'gig_picture_path': './media/gig_images/will_of_the_people.jpg'},
